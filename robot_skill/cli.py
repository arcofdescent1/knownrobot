...
def _parser() -> argparse.ArgumentParser:
    ...
    validate.add_argument("--level", choices=("structural", "complete"), default="complete", help="structural includes semantic checks; complete additionally requires pinned metadata")
