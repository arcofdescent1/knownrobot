...
export function SiteHeader() {
  return <header className="topbar public-header">
    ...
    <nav aria-label="Primary navigation"><Link href="/">Registry</Link><Link href="/validator">Validator</Link><Link href="/sprints">Sprints</Link><Link href="/thesis">Thesis</Link><Link href="/field-notes">Field notes</Link><Link href="/participate">Participate</Link><Link href="/account">Account</Link></nav>
