...
export const metadata: Metadata = pageMetadata("/field-notes", "Robot Policy Transfer and Reproducibility Guides — Known Robot", "Practical, evidence-linked guides to LeRobot policy transfer, SO-101 compatibility, calibration, evaluation protocols and reproducibility records.");
